...
export class ActivityLogsService {
      ...
      const activityLog =
        await this.prisma.activityLog.create({
          data: {
            ...
            status: (createActivityLogDto.status as ActivityStatus) || 'COMPLETED',
  ...
  async updateActivityLog(id: string, updateDto: UpdateActivityLogDto) {
    ...
    const updated = await this.prisma.activityLog.update({
      where: { id },
      data: {
        ...(updateDto.status !== undefined && { status: updateDto.status as ActivityStatus }),
        ...(updateDto.managerRemarks !== undefined && { managerRemarks: updateDto.managerRemarks }),
        ...(updateDto.isRework !== undefined && { isRework: updateDto.isRework }),
        ...(updateDto.reworkAssignedToId !== undefined && { reworkAssignedToId: updateDto.reworkAssignedToId }),
        ...(updateDto.reviewedBy !== undefined && { reviewedBy: updateDto.reviewedBy }),
        updatedAt: new Date(),
      },
    });
